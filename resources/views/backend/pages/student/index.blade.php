        ...
        <tr>
            ...
            <td>
                <a class="fee_status" id="btn_edit_fee_status_{{ $item['id'] }}">
                    <input type="checkbox" @if($item['fee_status']==1) checked @endif data-toggle="toggle" data-on="Đã nộp" data-off="Chưa nộp" data-onstyle="success" data-offstyle="danger">
                </a>
            ...
            <td>
                <a id="btn_edit_status_{{ $item['id'] }}">
                    <input type="checkbox" @if($item['status']==1) checked @endif data-toggle="toggle" data-on="Hoạt Động" data-off="Bảo Lưu" data-onstyle="success" data-offstyle="danger">
                </a>
