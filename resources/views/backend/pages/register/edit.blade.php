        ...
        <textarea readonly name="note" value=""class="form-control" >{{ $get_register->note }}</textarea>
          ...
          <div class="form-group mt-3">
            ...
            <select class="form-control" name="is_active" id="">
                <option @if($get_register->is_active == 1) selected @endif value="1">Đã xác nhận</option>
                <option @if($get_register->is_active == 0) selected @endif value="0">Chưa xác nhận</option>
            </select>
          </div>
