...
<form enctype="multipart/form-data" class="pl-5 pt-5" action="" method="POST">
    ...
    <div class="form-group">
        ...
        @if($users->role == 6)<input name="address" value="Tổng giám đốc" type="text" class="form-control">
        @elseif( $users->role == 5 ) <input name="address" value="Giám đốc chi nhánh" type="text" class="form-control">
        @elseif( $users->role == 4 ) <input name="address" value="Giáo viên" type="text" class="form-control">
        @elseif( $users->role == 3 ) <input name="address" value="Trợ giảng" type="text" class="form-control">
